...
const icon = {
  ...
  undo: (x, y, c = colors.text) => `<path d="M${x + 19} ${y + 12}H${x + 5}" stroke="${c}" stroke-width="1.8" stroke-linecap="round"/><path d="M${x + 12} ${y + 5}l-7 7 7 7" stroke="${c}" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>`,
